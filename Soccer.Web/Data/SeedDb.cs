...
namespace Soccer.Web.Data
{
    public class SeedDb
    {
        ...
        public async Task SeedAsync()
        {
            ...
            await CheckUserAsync("1010", "Deymer", "Perea", "deymer.ap@gmail.com", "321 611 8226", "Calle Luna Calle Sol", UserType.Admin);
            await CheckUserAsync("2020", "Deymer", "Perea", "deymersito_22@hotmail.com", "321 611 8226", "Calle Luna Calle Sol", UserType.User);
            await CheckUserAsync("3030", "Deymer", "Perea", "deymer.perea@siesa.com", "321 611 8226", "Calle Luna Calle Sol", UserType.User);
            await CheckUserAsync("4040", "Deymer", "Perea", "deymersito22@gmail", "321 611 8226", "Calle Luna Calle Sol", UserType.User);
